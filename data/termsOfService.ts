...
export const termsOfService: TermsOfService[] = [
    {
        ...
        privacySlug: "alrokchagok-macaron",
        supportedLocales: ["ko"],
        summary: koOnly("디스크팩토리가 제공하는 '알록차곡 마카롱 : 컬러 소트'의 서비스 이용조건과 회사 및 이용자의 권리·의무를 정합니다."),
        introduction: koOnly("본 약관은 디스크팩토리(이하 \"회사\")가 제공하는 모바일 게임 '알록차곡 마카롱 : 컬러 소트'와 이에 부수되는 웹페이지, 광고, 결제, 고객지원 및 기타 관련 서비스(이하 통칭하여 \"서비스\")의 이용조건을 정합니다."),
        effectiveDate: "2026-08-28",
        contactEmail: "contact@diskfactory.app",
        sections: [
            {
                kind: "purpose",
                title: koOnly("1. 목적 및 적용 범위"),
                paragraphs: [
                    koOnly("본 약관은 회사와 서비스를 이용하는 개인 이용자 사이의 권리, 의무, 책임사항 및 서비스 이용에 필요한 기본 사항을 규정합니다."),
                    koOnly("본 약관은 서비스에 표시되거나 연결된 때부터 적용됩니다. 이용자가 서비스를 설치하거나 이용하면 본 약관에 동의한 것으로 봅니다. 본 약관에 동의하지 않는 경우 서비스를 이용하지 않아야 합니다."),
                    koOnly("서비스는 Google Play, Apple App Store, Apps in Toss 등 회사가 지원하는 플랫폼을 통해 제공될 수 있으며, 플랫폼별 제공 기능과 이용조건에는 차이가 있을 수 있습니다."),
                ],
            },
            {
                kind: "eligibility",
                title: koOnly("2. 이용 자격 및 미성년자"),
                paragraphs: [
                    koOnly("이용자는 거주 국가의 법령에 따라 본 약관에 동의하고 서비스를 이용할 수 있는 능력이 있어야 합니다. 미성년자 또는 행위능력이 제한된 이용자는 법정대리인의 동의를 받아 서비스를 이용해야 합니다."),
                    koOnly("서비스는 만 14세 미만 아동을 주된 대상으로 하지 않습니다. 미성년자가 유료상품을 구매하려는 경우에는 법정대리인의 동의가 필요하며, 필요한 동의 없이 이루어진 결제는 관계 법령에 따라 취소할 수 있습니다."),
                ],
            },
            {
                kind: "service",
                title: koOnly("3. 서비스 제공, 변경 및 종료"),
                paragraphs: [
                    koOnly("회사는 게임 플레이, 스테이지와 진행 정보의 기기 내 저장, 광고, 유료상품, 고객지원 및 이에 부수되는 기능을 제공합니다. 실제 제공 기능은 앱 버전과 이용 플랫폼에 따라 달라질 수 있습니다."),
                    koOnly("회사는 운영상 또는 기술상 필요에 따라 업데이트, 점검, 오류 수정, 밸런스 조정, 콘텐츠 추가 또는 삭제 등 서비스의 전부 또는 일부를 변경할 수 있습니다."),
                    koOnly("회사는 설비 점검, 통신 장애, 보안 사고, 플랫폼 정책 변경, 천재지변, 법령 준수 또는 기타 불가피한 사유가 있는 경우 서비스 제공을 일시 중단할 수 있습니다. 가능한 경우 서비스 또는 회사 웹페이지를 통해 사전 또는 사후에 안내합니다."),
                    koOnly("회사는 사업상 또는 기술상 중대한 사유로 서비스를 종료할 수 있습니다. 이 경우 관계 법령이 정한 기간과 방법 또는 합리적인 기간 전에 서비스 내 공지, 회사 웹페이지 게시 등 적절한 방법으로 안내합니다."),
                ],
            },
            {
                kind: "accounts",
                title: koOnly("4. 계정 및 게임 진행 데이터"),
                paragraphs: [
                    koOnly("회사는 현재 서비스 이용을 위한 별도 회원계정을 운영하지 않습니다. 일부 기능은 Google Play, Apple App Store 또는 Apps in Toss 등 플랫폼 계정과 기능을 이용할 수 있으며, 해당 계정에는 각 플랫폼의 약관과 정책이 적용됩니다."),
                    koOnly("스테이지 진행, 별점, 설정 등 게임 진행 정보는 원칙적으로 이용자의 기기에 저장됩니다. 앱 삭제, 앱 데이터 초기화, 기기 변경, 운영체제 재설치 또는 저장공간 손상 시 진행 정보가 삭제되거나 복구되지 않을 수 있습니다."),
                    koOnly("회사가 향후 계정 연동이나 클라우드 저장 기능을 추가하는 경우에는 적용 전에 필요한 이용조건과 개인정보 처리 내용을 별도로 안내합니다."),
                ],
            },
            {
                kind: "ads",
                title: koOnly("5. 광고"),
                paragraphs: [
                    koOnly("서비스는 무료 제공을 위해 스테이지 결과 화면 등 게임 진행의 경계에서 전면형 광고를 포함할 수 있습니다. 광고의 유형, 빈도 및 제공 사업자는 앱 버전과 이용 플랫폼에 따라 달라질 수 있습니다."),
                    koOnly("광고 제공 과정에서 광고 식별자, 앱·기기 정보, 대략적인 위치, 광고 노출·상호작용 정보 및 진단정보가 광고 사업자 또는 플랫폼에 의해 처리될 수 있습니다. 자세한 내용과 이용자의 선택 방법은 개인정보처리방침에서 확인할 수 있습니다."),
                    koOnly("회사가 광고 제거 상품을 제공하는 경우 제거되는 광고의 범위는 상품 구매 화면에 표시합니다. 플랫폼이 직접 표시하는 안내, 회사가 제공하지 않는 제3자 콘텐츠 또는 상품 설명에서 제외한다고 명시한 광고에는 해당 상품이 적용되지 않을 수 있습니다."),
                ],
            },
            {
                kind: "payments",
                title: koOnly("6. 유료상품, 결제 및 환불"),
                paragraphs: [
                    koOnly("회사는 플랫폼을 통해 일회성 광고 제거 등 유료 디지털 상품을 제공할 수 있습니다. 상품의 가격, 통화, 제공 내용 및 이용조건은 구매 전에 서비스 또는 플랫폼 결제 화면에 표시합니다."),
                    koOnly("결제, 청약철회, 환불 및 구매 복원은 Google Play, Apple App Store, Apps in Toss 등 이용한 플랫폼의 결제수단과 정책 및 관계 법령에 따라 처리됩니다. 카드번호나 계좌번호 등 결제수단 정보는 플랫폼이 직접 처리하며 회사는 직접 수집하거나 저장하지 않습니다."),
                    koOnly("구매한 상품이 정상적으로 제공되지 않은 경우 이용자는 구매 플랫폼의 고객지원 또는 contact@diskfactory.app으로 문의할 수 있습니다. 회사는 확인에 필요한 최소한의 주문번호나 거래 식별정보를 요청할 수 있습니다."),
                ],
            },
            {
                kind: "user_conduct",
                title: koOnly("7. 이용자의 의무"),
                paragraphs: [
                    koOnly("이용자는 관계 법령, 본 약관, 플랫폼 정책, 서비스 내 안내 및 다른 이용자의 권리를 준수해야 합니다."),
                ],
                bullets: [
                    koOnly("서비스 또는 콘텐츠를 무단 복제, 배포, 판매, 임대하거나 영리 목적으로 이용하는 행위"),
                    koOnly("버그, 취약점, 자동화 도구, 변조 프로그램, 비정상적인 네트워크 요청 등을 이용하여 서비스의 정상 운영을 방해하거나 부당한 이익을 얻는 행위"),
                    koOnly("서비스, 서버, 플랫폼 또는 다른 이용자의 기기와 정보에 무단으로 접근하거나 접근을 시도하는 행위"),
                    koOnly("회사를 사칭하거나 타인의 권리, 명예, 개인정보 또는 지식재산권을 침해하는 행위"),
                    koOnly("그 밖에 관계 법령이나 선량한 풍속 및 사회질서에 반하는 행위"),
                ],
            },
            {
                kind: "enforcement",
                title: koOnly("8. 이용 제한"),
                paragraphs: [
                    koOnly("이용자가 본 약관이나 관계 법령을 위반하거나 서비스의 안전과 정상 운영을 해치는 경우 회사는 사전 통지 후 해당 기능의 이용 제한, 비정상 데이터의 수정 또는 기타 필요한 조치를 할 수 있습니다. 긴급한 보안 대응, 피해 확산 방지 또는 법령상 의무 이행이 필요한 경우에는 사후에 통지할 수 있습니다."),
                    koOnly("이용자는 회사의 조치에 이의가 있는 경우 contact@diskfactory.app으로 사유와 관련 자료를 제출할 수 있으며, 회사는 합리적인 기간 내에 검토 결과를 안내합니다."),
                ],
            },
            {
                kind: "ip",
                title: koOnly("9. 지식재산권"),
                paragraphs: [
                    koOnly("서비스와 회사가 제공하는 게임, 소프트웨어, 그래픽, 캐릭터, 음악, 효과음, 문구, 상표 및 기타 콘텐츠에 관한 지식재산권은 회사 또는 정당한 권리자에게 귀속됩니다."),
                    koOnly("회사는 이용자에게 본 약관을 준수하는 조건으로 개인적이고 비상업적인 오락 목적에 한정된 비독점적, 양도 불가능하고 철회 가능한 서비스 이용권을 부여합니다. 이용자는 회사 또는 권리자의 사전 허락 없이 콘텐츠를 복제, 수정, 배포, 전송, 판매, 역설계하거나 2차적 저작물을 작성할 수 없습니다. 다만 관계 법령이 명시적으로 허용하는 경우는 예외로 합니다."),
                ],
            },
            {
                kind: "privacy",
                title: koOnly("10. 개인정보 보호"),
                paragraphs: [
                    koOnly("회사는 관계 법령과 별도로 공개하는 '알록차곡 마카롱 : 컬러 소트 개인정보처리방침'에 따라 개인정보를 처리합니다. 개인정보처리방침은 본 약관과 함께 서비스 또는 회사 웹페이지에서 확인할 수 있습니다."),
                ],
            },
            {
                kind: "third_party",
                title: koOnly("11. 제3자 플랫폼 및 서비스"),
                paragraphs: [
                    koOnly("서비스는 Google Play, Apple App Store, Apps in Toss, 광고 및 결제 서비스 등 제3자 플랫폼이나 서비스와 연결될 수 있습니다. 제3자가 직접 제공하는 기능에는 해당 사업자의 약관과 개인정보처리방침이 적용됩니다."),
                    koOnly("회사는 제3자 서비스의 장애, 정책 변경 또는 제공 중단으로 서비스의 일부 기능을 변경하거나 중단할 수 있습니다. 다만 회사의 고의 또는 과실로 이용자에게 손해가 발생한 경우에는 관계 법령에 따른 책임을 부담합니다."),
                ],
            },
            {
                kind: "changes",
                title: koOnly("12. 약관의 변경"),
                paragraphs: [
                    koOnly("회사는 관계 법령을 위반하지 않는 범위에서 본 약관을 변경할 수 있습니다. 변경하는 경우 적용일, 변경 내용 및 변경 사유를 원칙적으로 적용일 7일 전부터 서비스 또는 회사 웹페이지에 안내합니다."),
                    koOnly("이용자에게 불리하거나 권리·의무에 중대한 영향을 주는 변경은 원칙적으로 적용일 30일 전부터 안내합니다. 관계 법령상 별도의 동의가 필요한 변경은 적법한 방법으로 동의를 받습니다."),
                    koOnly("이용자가 변경 약관의 적용일 이후에도 서비스를 계속 이용하는 경우 변경 약관에 동의한 것으로 볼 수 있습니다. 이용자는 변경 약관에 동의하지 않는 경우 서비스 이용을 중단하고 앱을 삭제할 수 있습니다."),
                ],
            },
            {
                kind: "liability",
                title: koOnly("13. 책임 및 보증의 범위"),
                paragraphs: [
                    koOnly("회사는 관련 법령이 허용하는 범위에서 서비스를 현재 상태로 제공하며, 모든 기기와 환경에서 서비스가 항상 중단이나 오류 없이 동작하거나 이용자의 모든 기대를 충족한다고 보증하지 않습니다."),
                    koOnly("천재지변, 통신망 장애, 플랫폼 장애, 이용자의 기기나 관리상 문제 또는 회사가 합리적으로 통제하기 어려운 사유로 발생한 손해에 대하여 회사는 고의 또는 과실이 없는 한 책임을 지지 않습니다."),
                    koOnly("본 약관의 어떠한 내용도 소비자 보호 등 강행 법규에 따라 회사가 부담하는 책임을 배제하거나 부당하게 제한하지 않습니다."),
                ],
            },
            {
                kind: "law",
                title: koOnly("14. 준거법 및 분쟁 해결"),
                paragraphs: [
                    koOnly("본 약관은 대한민국 법률을 준거법으로 합니다. 회사와 이용자는 서비스와 관련한 분쟁을 원만하게 해결하기 위해 성실히 협의합니다."),
                    koOnly("협의로 해결되지 않는 분쟁의 관할은 민사소송법 등 관계 법령이 정한 절차에 따릅니다. 이용자는 관계 법령에 따라 소비자분쟁조정 등 이용 가능한 분쟁 해결 절차를 이용할 수 있습니다."),
                ],
            },
            {
                kind: "contact",
                title: koOnly("15. 회사 정보 및 문의"),
                paragraphs: [
                    koOnly("회사: 디스크팩토리(DiskFactory)"),
