...
export const privacyPolicies: PrivacyPolicy[] = [
    {
        slug: "alrokchagok-macaron",
        appName: koOnly("알록차곡 마카롱 : 컬러 소트"),
        supportedLocales: ["ko"],
        summary: koOnly("별도 회원가입 계정 없이 서비스 제공에 필요한 최소한의 정보만 처리하며, 개인정보를 판매하지 않습니다."),
        introduction: koOnly("디스크팩토리(이하 \"회사\")는 모바일 게임 '알록차곡 마카롱 : 컬러 소트'(이하 \"서비스\") 이용자의 개인정보를 보호하고 개인정보 처리에 관한 절차와 기준을 안내하기 위해 다음과 같이 개인정보처리방침을 공개합니다."),
        effectiveDate: "2026-08-28",
        contactEmail: "contact@diskfactory.app",
        sections: [
            {
                kind: "collection",
                title: koOnly("1. 처리하는 개인정보와 이용 목적"),
                paragraphs: [
                    koOnly("회사는 서비스 이용을 위한 별도 회원가입 계정을 운영하지 않으며 이름, 생년월일, 전화번호, 비밀번호 또는 주민등록번호를 직접 입력받지 않습니다."),
                    koOnly("서비스 제공, 광고, 결제 확인 및 고객문의 처리를 위해 이용 플랫폼과 사용 기능에 따라 다음 정보 중 일부가 자동으로 생성되거나 외부 플랫폼을 통해 처리될 수 있습니다."),
                ],
                table: {
                    ...
                    rows: [
                        [
                            koCell("기기 내 게임 진행"),
                            koCell("스테이지 진행, 완료 여부, 별점, 게임 설정 및 저장 상태"),
                            koCell("게임 진행 저장 및 복원"),
                        ],
                        [
                            koCell("광고"),
                            koCell("IP 주소와 이를 통해 추정한 대략적 위치, 광고 ID·앱 세트 ID 등 기기 또는 앱 식별정보, 앱 실행·탭·광고 및 동영상 조회 등 이용자 상호작용, 앱·광고 SDK의 성능 및 진단정보"),
                            koCell("광고 제공, 광고 효과 측정, 이용 통계 및 부정 이용 방지"),
                        ],
                        [
                            koCell("Apps in Toss"),
                            koCell("앱 버전과 플랫폼 정보, 크래시 발생률, 로딩 시간, FPS 등 성능 지표, 광고 노출·상호작용 정보"),
                            koCell("Apps in Toss 환경에서의 서비스 제공, 성능 개선, 광고 제공 및 정산"),
                        ],
                        [
                            koCell("결제"),
                            koCell("플랫폼 이용자·상품·주문·거래 식별정보, 가격·통화, 구매·복원·취소·환불 상태 및 오류기록"),
                            koCell("광고 제거 상품 등 유료상품의 결제 확인, 혜택 제공, 구매 복원 및 고객지원"),
                        ],
                        [
                            koCell("고객문의"),
                            koCell("이메일 주소, 플랫폼 문의 식별정보, 문의 내용, 주문번호 및 이용자가 첨부한 자료"),
                            koCell("본인 및 거래 확인, 문의 답변, 불만 및 분쟁 처리"),
                        ],
                    ],
                },
                notes: [
                    koOnly("게임 진행 정보는 원칙적으로 이용자의 기기에만 저장되며 회사 서버로 전송되지 않습니다. 앱 삭제 또는 앱 데이터 초기화 시 해당 정보가 삭제될 수 있습니다."),
                    koOnly("카드번호와 계좌번호 등 결제수단 정보는 Google Play, Apple App Store 또는 Apps in Toss 등 결제 플랫폼이 직접 처리하며 회사는 직접 수집하거나 저장하지 않습니다."),
                    koOnly("회사는 개인정보를 판매하지 않으며, 광고·분석 목적으로 이름, 이메일 주소나 전화번호와 같은 직접 식별정보를 의도적으로 사용하지 않습니다."),
                ],
            },
            {
                kind: "retention",
                title: koOnly("2. 개인정보의 처리 및 보유기간과 파기"),
                paragraphs: [
                    koOnly("회사는 처리 목적이 달성되거나 보유기간이 끝난 개인정보를 지체 없이 파기합니다. 전자적 정보는 복구하기 어려운 방법으로 삭제하고, 종이 문서는 분쇄하거나 소각합니다."),
                    koOnly("관계 법령에 따라 일정 기간 보존해야 하는 정보는 해당 기간 동안 다른 정보와 분리하여 보관하고, 정해진 목적 이외에는 이용하지 않습니다."),
                ],
                bullets: [
                    koOnly("기기 내 게임 진행 정보: 이용자가 앱을 삭제하거나 앱 데이터를 초기화할 때까지(회사는 별도로 보유하지 않음)"),
                    koOnly("광고·플랫폼·성능 정보: 각 외부 서비스의 설정과 개인정보처리방침에서 정한 기간"),
                    koOnly("계약 또는 청약철회, 대금결제 및 서비스 공급에 관한 기록: 5년(전자상거래 등에서의 소비자보호에 관한 법률)"),
                    koOnly("소비자 불만 또는 분쟁 처리에 관한 기록: 3년(전자상거래 등에서의 소비자보호에 관한 법률)"),
                    koOnly("결제와 무관한 일반 문의기록: 답변 완료 후 1년"),
                ],
            },
            {
                kind: "sharing",
                title: koOnly("3. 개인정보의 제3자 제공, 처리위탁 및 외부 플랫폼"),
                paragraphs: [
                    koOnly("회사는 이용자의 개인정보를 판매하지 않으며, 이용자의 동의가 있거나 법령에 근거가 있는 경우를 제외하고 처리 목적을 벗어나 제3자에게 제공하지 않습니다."),
                    koOnly("회사는 서비스 운영에 필요한 범위에서 아래 외부 사업자의 서비스를 이용합니다. 각 사업자는 회사로부터 업무를 위탁받거나, 이용자와 직접 관계를 맺는 독립된 플랫폼 사업자로서 해당 사업자의 개인정보처리방침에 따라 정보를 처리할 수 있습니다."),
                ],
                table: {
                    caption: koOnly("외부 사업자와 처리 업무"),
                    headers: [koOnly("사업자"), koOnly("처리 업무"), koOnly("정책")],
                    rows: [
                        [
                            koCell("Google LLC"),
                            koCell("Google Mobile Ads를 통한 광고 제공·측정·이용 통계·부정 이용 방지, Google Play 앱 배포 및 결제 처리"),
                            koCell("Google 개인정보처리방침", "https://policies.google.com/privacy"),
                        ],
                        [
                            koCell("Apple Inc."),
                            koCell("Apple App Store 앱 배포, 결제·구매 복원 및 플랫폼 기능 제공"),
                            koCell("Apple 개인정보처리방침", "https://www.apple.com/legal/privacy/"),
                        ],
                        [
                            koCell("비바리퍼블리카 주식회사"),
                            koCell("Apps in Toss 플랫폼, Unity SDK, 성능 측정, 인앱 광고·결제 및 정산 기능 제공"),
                            koCell("토스 개인정보처리방침", "https://toss.im/privacy"),
                        ],
                    ],
                },
                notes: [
                    koOnly("Google Play, Apple App Store 및 Apps in Toss가 앱 배포, 플랫폼 계정 또는 결제를 위해 이용자로부터 직접 수집하는 정보에는 각 플랫폼의 약관과 개인정보처리방침이 적용됩니다."),
                    koOnly("법원, 수사기관 또는 행정기관이 법령에 정해진 절차와 방법에 따라 요청하는 경우 회사는 필요한 범위에서 정보를 제공할 수 있습니다."),
                ],
            },
            {
                kind: "sharing",
                ...
                paragraphs: [
                    koOnly("국외 사업자가 처리하는 정보는 서비스 이용계약의 이행에 필요한 처리위탁·보관, 이용자의 동의 또는 그 밖에 개인정보 보호법 제28조의8에서 정한 근거에 따라 국외로 이전될 수 있습니다. 별도 동의가 필요한 경우에는 이전 전에 필요한 내용을 안내하고 동의를 받습니다."),
                    koOnly("이용자는 기기의 광고·개인정보 보호 설정을 변경하거나 선택 기능을 이용하지 않는 방법으로 일부 국외 처리를 제한할 수 있습니다. 다만 광고 또는 결제에 필수적인 처리를 거부하면 일반 광고가 제공되거나 해당 기능을 이용하기 어려울 수 있습니다."),
                ],
                table: {
                    ...
                    rows: [
                        [
                            ...
                            koCell("IP 주소, 대략적 위치, 광고·앱·기기 식별정보, 이용자 상호작용 및 성능·진단정보 / 광고 제공·측정·통계 및 부정 이용 방지"),
                            koCell("광고 요청 또는 앱 이용 시 암호화된 네트워크를 통해 전송"),
                            koCell("미국 및 Google이 공개한 서비스 처리시설 소재 국가 / Google의 서비스 설정, 개인정보처리방침 또는 관계 법령에 따른 기간"),
                        ],
                    ],
                },
            },
            {
                kind: "deletion",
                title: koOnly("5. 이용자와 법정대리인의 권리 및 행사방법"),
                paragraphs: [
                    koOnly("이용자 또는 법정대리인은 개인정보의 열람, 정정, 삭제, 처리정지 및 동의 철회를 요청할 수 있습니다. 요청은 contact@diskfactory.app 또는 이용한 플랫폼의 고객문의 기능을 통해 접수할 수 있으며, 회사는 관계 법령에 따라 지체 없이 처리합니다."),
                    koOnly("회사가 별도 회원계정을 운영하지 않으므로 요청 대상을 확인하기 위해 플랫폼 이용자 식별정보, 주문번호 또는 문의 이력 등 최소한의 확인정보를 요청할 수 있습니다. 플랫폼이 직접 관리하는 정보는 해당 플랫폼의 설정이나 고객지원을 통해 처리해야 할 수 있습니다."),
                    koOnly("이용자는 기기에서 앱을 삭제하거나 앱 데이터를 초기화하여 기기에 저장된 게임 진행 정보를 삭제할 수 있습니다. 앱 삭제 시 앱을 통한 추가 정보 전송은 중단되지만, 관계 법령에 따른 거래기록이나 이미 외부 사업자가 처리한 정보가 자동으로 모두 삭제되는 것은 아닙니다."),
                ],
            },
            {
                kind: "collection",
                title: koOnly("6. 자동 수집 정보와 이용자의 선택"),
                paragraphs: [
                    koOnly("회사는 자체적인 웹 쿠키를 이용해 게임 이용자를 추적하지 않습니다. 다만 Google Mobile Ads와 Apps in Toss 플랫폼·SDK는 광고, 서비스 제공, 성능 측정 및 부정 이용 방지를 위해 광고 식별자, 앱·기기 정보, 이용자 상호작용 및 진단정보를 자동으로 처리할 수 있습니다."),
                    koOnly("이용자는 Android의 개인정보 보호·광고 메뉴에서 광고 ID를 재설정 또는 삭제하고 맞춤형 광고를 제한할 수 있으며, iOS의 개인정보 보호 및 보안·추적 메뉴에서 앱 추적 허용 여부를 변경할 수 있습니다. Apps in Toss 이용자는 토스 앱에서 제공하는 개인정보 보호·광고 설정을 이용할 수 있습니다."),
                    koOnly("지역과 법령에 따라 광고 동의 또는 개인정보 선택 화면이 제공되는 경우 이용자는 해당 화면에서 선택을 변경할 수 있습니다. 맞춤형 광고를 제한하더라도 일반 광고는 표시될 수 있습니다."),
                ],
            },
            {
                kind: "children",
                title: koOnly("7. 만 14세 미만 아동의 개인정보"),
                paragraphs: [
                    koOnly("서비스는 만 14세 미만 아동을 주된 대상으로 설계하거나 마케팅하지 않으며, 회사는 이용자의 생년월일이나 연령을 직접 수집하지 않습니다."),
                    koOnly("만 14세 미만 아동이 고객문의 등 별도 동의가 필요한 방식으로 개인정보를 제공하는 경우에는 법정대리인의 동의가 필요합니다. 회사가 필요한 동의 없이 아동의 개인정보가 수집된 사실을 확인하면 해당 정보를 삭제하거나 필요한 보호조치를 합니다."),
                ],
            },
            {
                kind: "security",
                title: koOnly("8. 개인정보의 안전성 확보조치"),
                paragraphs: [
                    koOnly("회사는 개인정보를 안전하게 처리하기 위해 처리 인원의 최소화와 접근권한 관리, 암호화 통신, 보안 업데이트, 처리기록 보호 및 외부 서비스 제공업체 관리 등 필요한 기술적·관리적 보호조치를 적용합니다."),
                ],
            },
            {
                kind: "changes",
                title: koOnly("9. 개인정보처리방침의 변경"),
                paragraphs: [
                    koOnly("회사가 본 방침을 변경하는 경우 적용일, 변경 내용 및 변경 사유를 원칙적으로 시행 7일 전부터 이 페이지 또는 서비스 내 공지를 통해 안내합니다."),
                    koOnly("개인정보의 수집·이용 목적, 제3자 제공대상 등 이용자의 권리에 중대한 영향을 미치는 변경은 원칙적으로 시행 30일 전에 안내하며, 관계 법령상 별도의 동의가 필요한 경우 적법한 방법으로 동의를 받습니다."),
                ],
            },
            {
                kind: "contact",
                title: koOnly("10. 개인정보 보호책임자 및 권익침해 구제"),
                paragraphs: [
                    koOnly("개인정보 보호책임자: 여재훈"),
                    koOnly("회사: 디스크팩토리 / 주소: 서울특별시 마포구 월드컵로 196, B105-E176호"),
                    koOnly("개인정보 문의 및 권리 행사: contact@diskfactory.app"),
                    koOnly("개인정보 침해에 대한 상담이나 구제가 필요한 경우 개인정보침해신고센터(국번 없이 118, privacy.kisa.or.kr) 또는 개인정보분쟁조정위원회(1833-6972, kopico.go.kr)를 이용할 수 있습니다."),
                ],
            },
        ],
    },
        ...
        sections: [
            {
                ...
                paragraphs: [
                    ...
                    {
                        ko: "Google Play Games Services를 사용하는 경우 로그인, 업적, 리더보드 등 게임 기능 제공과 이용 분석을 위해 플랫폼 이용자 식별정보가 처리될 수 있습니다.",
                        en: "When you use Google Play Games Services, platform user identifiers may be processed to provide game features such as sign-in, achievements, and leaderboards and to analyze usage.",
                        "pt-BR": "Quando você usa o Google Play Games Services, identificadores de usuário da plataforma podem ser tratados para fornecer recursos como login, conquistas e rankings e para analisar o uso.",
                    },
                    {
                        ko: "서비스 개선과 게임 이용 분석을 위해 가명 처리된 식별정보, 게임 이용기록 및 앱·기기정보가 처리될 수 있습니다.",
                        en: "Pseudonymous identifiers, gameplay records, and app or device information may be processed to improve the Service and analyze game usage.",
                        "pt-BR": "Identificadores pseudonimizados, registros de uso do jogo e informações do aplicativo ou dispositivo podem ser tratados para melhorar o Serviço e analisar o uso do jogo.",
                    },
                    {
                        ko: "앱 안정성 개선과 오류 대응을 위해 오류·크래시 및 성능 진단정보가 처리될 수 있습니다.",
                        en: "Error, crash, and performance diagnostic information may be processed to improve app stability and respond to errors.",
                        "pt-BR": "Informações de erro, falha e diagnóstico de desempenho podem ser tratadas para melhorar a estabilidade do aplicativo e responder a erros.",
                    },
                    {
                    ...
                    {
                        ko: "서비스 제공자는 게임 이용 분석 목적으로 이름, 이메일 주소, 전화번호 등 직접적인 개인식별정보를 의도적으로 사용하지 않습니다.",
                        en: "The Service Provider does not intentionally use directly identifying information such as your name, email address, or phone number for game-usage analytics.",
                        "pt-BR": "O Provedor do Serviço não usa intencionalmente informações de identificação direta, como nome, endereço de e-mail ou telefone, para analisar o uso do jogo.",
                    },
                ],
                bullets: [
                    {
                        ko: "플랫폼 이용자 식별정보",
                        en: "Platform user identifiers",
                        "pt-BR": "Identificadores de usuário da plataforma",
                    },
                    {
                        ko: "레벨 진행, 점수, 실패·재시도 및 게임 내 상호작용 등 게임 이용기록",
                        en: "Gameplay records such as level progress, scores, failures or retries, and in-game interactions",
                        "pt-BR": "Registros de uso do jogo, como progresso nas fases, pontuações, falhas ou novas tentativas e interações no jogo",
                    },
                    {
                        ko: "앱 버전, 기기 모델, 운영체제, 언어·지역 및 IP 기반 대략 위치 등 앱·기기정보",
                        en: "App and device information such as app version, device model, operating system, language or region, and approximate location inferred from IP address",
                        "pt-BR": "Informações do aplicativo e do dispositivo, como versão do aplicativo, modelo do dispositivo, sistema operacional, idioma ou região e localização aproximada inferida pelo endereço IP",
                    },
                    {
                        ko: "오류·크래시 및 성능 진단정보",
                        en: "Error, crash, and performance diagnostic information",
                        "pt-BR": "Informações de erro, falha e diagnóstico de desempenho",
                    },
                ],
            },
            {
                ...
                paragraphs: [
                    {
                        ko: "서비스 제공자는 게임 기능 및 광고 제공, 이용 분석과 오류 대응에 필요한 범위에서 정보를 외부 서비스 제공업체를 통해 처리할 수 있습니다.",
                        en: "The Service Provider may process information through external service providers as needed to provide game features and ads, analyze usage, and respond to errors.",
                        "pt-BR": "O Provedor do Serviço pode tratar informações por meio de prestadores externos conforme necessário para fornecer recursos do jogo e anúncios, analisar o uso e responder a erros.",
                    },
                    {
                    ...
                    {
                        ko: "Mixpanel과 Google Analytics for Firebase는 이용 분석, Sentry와 Firebase Crashlytics는 오류 진단, AdMob은 광고 제공, Google Play Games Services와 Unity는 게임 기능 제공을 위해 사용될 수 있습니다.",
                        en: "Mixpanel and Google Analytics for Firebase may be used for usage analytics, Sentry and Firebase Crashlytics for error diagnostics, AdMob for advertising, and Google Play Games Services and Unity for game features.",
                        "pt-BR": "O Mixpanel e o Google Analytics for Firebase podem ser usados para análise de uso, o Sentry e o Firebase Crashlytics para diagnóstico de erros, o AdMob para publicidade e o Google Play Games Services e a Unity para recursos do jogo.",
                    },
                ],
                services: [
                    {
            ...
            },
            {
                ...
                paragraphs: [
                    {
                        ko: "애플리케이션을 삭제하면 일반적으로 해당 기기의 애플리케이션을 통한 추가 정보 수집이 중단됩니다.",
                        en: "Uninstalling the Application generally stops additional information collection through the Application on that device.",
                        "pt-BR": "A desinstalação do Aplicativo geralmente interrompe novas coletas de informações por meio do Aplicativo naquele dispositivo.",
                    },
                    {
                        ko: "게임 이용 분석정보와 오류·진단정보의 삭제를 요청하려면 아래 연락처로 문의할 수 있습니다. 서비스 제공자는 요청 확인에 필요한 최소한의 정보를 요청할 수 있으며, 확인 후 합리적인 기간 내에 관련 정보를 삭제하거나 익명화합니다. Google 계정과 Google Play Games Services 등 외부 플랫폼이 직접 관리하는 정보는 해당 플랫폼의 설정과 정책에 따릅니다.",
                        en: "To request deletion of game-usage analytics or error and diagnostic information, contact the Service Provider using the details below. The Service Provider may request the minimum information needed to verify the request and will delete or anonymize the relevant information within a reasonable period after verification. Information managed directly by external platforms, such as Google Accounts and Google Play Games Services, is subject to those platforms' settings and policies.",
                        "pt-BR": "Para solicitar a exclusão de informações de análise do uso do jogo ou de erro e diagnóstico, entre em contato com o Provedor do Serviço pelos dados abaixo. O Provedor do Serviço pode solicitar apenas as informações mínimas necessárias para verificar o pedido e excluirá ou anonimizará as informações pertinentes em prazo razoável após a verificação. Informações gerenciadas diretamente por plataformas externas, como Contas Google e Google Play Games Services, seguem as configurações e políticas dessas plataformas.",
                    },
                ],
            },
            {
                ...
                paragraphs: [
                    ...
                    {
                        ko: "게임 이용 분석정보와 오류·진단정보는 처리 목적에 필요한 기간 동안 보유되며, 목적 달성 또는 삭제 요청 처리 후 삭제하거나 익명화합니다.",
                        en: "Game-usage analytics and error or diagnostic information are retained for as long as needed for their processing purposes and are deleted or anonymized after those purposes are fulfilled or a deletion request is processed.",
                        "pt-BR": "Informações de análise do uso do jogo e de erro ou diagnóstico são mantidas pelo período necessário às suas finalidades e excluídas ou anonimizadas após o cumprimento dessas finalidades ou o processamento de uma solicitação de exclusão.",
                    },
                ],
            },
            {
